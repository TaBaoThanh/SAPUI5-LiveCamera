! function (e, t) {
	"object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(
		"JslibHtml5CameraPhoto", [], t) : "object" == typeof exports ? exports.JslibHtml5CameraPhoto = t() : e.JslibHtml5CameraPhoto = t()
}(this, function () {
	return function (e) {
		function t(i) {
		...
		function i(e, t) {
			...
			if (!d.f.includes(e)) throw new Error(e + " is invalid imageType, choose between: " + d.f.join(", "));
			return !0
		}
		...
		function r(e, t) {
			...
			try {
				...
				console.error(e), console.error("default value of " + d.c.PNG + " is used"), n.imageType = d.c.PNG, n.imageCompression = null
			}
			return n
		}
		...
		function u(e, t, n) {
			return r(t, n).imageType === d.c.JPG ? n ? e.toDataURL(d.b[d.c.JPG], n) : e.toDataURL(d.b[d.c.JPG]) : e.toDataURL(d.b[t])
		}
		...
		function s() {
			var e = o();
			return !!(e.match(/iPad/i) || e.match(/iPhone/i) || e.match(/iPod/i)) || !!(e.match(/Mac/i) && "ontouchend" in document)
		}

		function f() {
			return console.log(window.navigator.userAgent), console.log(window.navigator.platform), {
